...
export default function MainNewsPage() {
  ...
  const save = async () => {
    ...
    try {
      await createNews({ ...form, type: 'main' });
  ...
  return (
    <div className="flex">
      ...
      <main className="flex-1 p-8 bg-[#15100A] text-amber-50 min-h-screen">
        <Helmet>
          <title>Hekayaty News - Admin</title>
        </Helmet>
        <h1 className="text-3xl font-bold font-cinzel mb-6">Hekayaty News</h1>
